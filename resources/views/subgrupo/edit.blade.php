                ...
                <div class="card-body">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Sub subGrupos</h3>
                        ...
                        <thead>
                            ...
                            <tbody>
                                @forelse($subgrupos as $grp)
                                    <tr>
                                    <td>{{$grp->id}}</td>
                                    <td>{{$grp->descricao}}</td>
                                    <td><a class="btn btn-block btn-warning" href="{{ route('subgrupo.edit', [$grp->id])}}"> <i class="fa fa-edit"></i> Editar</a></td>
                                    <td>
                                        <form action="{{ route('subgrupo.excluir',  $grp->id )}}" method="get">
                                            @csrf
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="{{ route('subgrupo.update', [$subgrupo->id])}}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
